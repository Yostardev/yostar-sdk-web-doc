...
|     sign     | 字符串 |               必填，验证参数               |
|   itemName   | 字符串 |           商品名，美服必填，韩服必填，日服忽略            |
